...
-- --------------------------------------------------
-- Date Created: 09/01/2013 22:07:32
-- Generated from EDMX file: C:\Users\Peter.Kuijpers\Documents\VB2010Projects\TTMS\TTMS\Model1.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[Permissions1] (
    ...
    [Status_code] nvarchar(max)  NOT NULL
);
GO
...
-- Creating primary key on [Code] in table 'NCR_Status'
ALTER TABLE [dbo].[NCR_Status]
ADD CONSTRAINT [PK_NCR_Status]
    PRIMARY KEY CLUSTERED ([Code] ASC);
GO

-- Creating primary key on [Level_id], [Status_code] in table 'Permissions1'
ALTER TABLE [dbo].[Permissions1]
ADD CONSTRAINT [PK_Permissions1]
    PRIMARY KEY NONCLUSTERED ([Level_id], [Status_code] ASC);
GO
...
-- Creating foreign key on [Status_code] in table 'Permissions1'
ALTER TABLE [dbo].[Permissions1]
...
-- Creating foreign key on [status_code] in table 'NCRs'
ALTER TABLE [dbo].[NCRs]
